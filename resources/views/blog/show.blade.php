    ...
    <div>
        <div class="flex flex-wrap space-x-2 border-t border-dashed border-gray-400 py-6">
            <a rel="noopener noreferrer" href="#"
                class="rounded-sm bg-violet-400 px-3 py-1 text-gray-900 hover:underline">#MambaUI</a>
            <a rel="noopener noreferrer" href="#"
                class="rounded-sm bg-violet-400 px-3 py-1 text-gray-900 hover:underline">#TailwindCSS</a>
            <a rel="noopener noreferrer" href="#"
                class="rounded-sm bg-violet-400 px-3 py-1 text-gray-900 hover:underline">#Angular</a>
        </div>
    </div>
</x-main-layout>
